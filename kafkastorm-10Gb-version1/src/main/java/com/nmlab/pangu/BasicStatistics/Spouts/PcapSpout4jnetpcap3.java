...
public class PcapSpout4jnetpcap3 implements IRichSpout {
	...
	// long countPacket = 0;
	 //PcapHeader hdr;  
     	//JBuffer buf; 
	PcapPacket packet;
    public PcapSpout4jnetpcap3(){};
   
    
    public PcapSpout4jnetpcap3(String deviceName, int count, String filter, String srcFilename, String dstFilename, int sampLen,String topic){
    ...
    public PcapSpout4jnetpcap3(String deviceName, String count, String filter, String srcFilename, String dstFilename, String sampLen,String topic){
    	this.deviceName = deviceName;
		...
		try{
		    ...
		    //if(pcap.nextEx(packet)==1)
			{
				...
				*/
				...
				if(p1.hasHeader(Ip4.ID))
				{
					//System.out.println("in pkt.hasHeader(Ip4.ID)");
					p1.getHeader(ip4);
					src=FormatUtils.asString(ip4.source());
					dst=FormatUtils.asString(ip4.destination());
				}
				*/
